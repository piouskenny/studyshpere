...
Route::post('/tutor_addQualification/{id}', [TutorAuthController::class, 'uploadQualification'])->name('tutor_addQualification');
...
Route::post('/admin/verifyTutor/{id}', [AdminController::class, 'verifyTutor'])->name('admin_verifyTutor')->middleware('admin_auth');
