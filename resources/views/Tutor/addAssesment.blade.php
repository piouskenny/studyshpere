    ...
    <div class="content-wrapper bg-light">
        <div class="row justify-content-center">
            <div class="col-md-6 shadow-sm">
                ...
                <form action="{{route('createAssementPost')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <input type="text" name="course_id" value="{{$course->id}}" class="form-control" hidden />
                    <input type="text" name="tutor_id" value="{{$tutor->id}}" class="form-control" hidden />

                    <div data-mdb-input-init class="form-outline mb-4">
                        <label class="form-label" for="form6Example4">Question</label>
                        <textarea class="form-control" row="6" name="question"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input class="form-control" id="option_a" name="option_a" type="text" />
                        </div>
                        <span class="d-block text-danger mt-2">
                            @error('option_a')
                            {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input class="form-control" id="option_b" name="option_b" type="text" />
                        </div>
                        <span class="d-block text-danger mt-2">
                            @error('option_b')
                            {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input class="form-control" id="option_c" name="option_c" type="text" />
                        </div>
                        <span class="d-block text-danger mt-2">
                            @error('option_c')
                            {{ $message }}
